...
export const STAGES: Stage[] = [
  {
    ...
    sub: "Discovery phase — You are validating the problem and defining your market.",
    diagnosisClass: "red",
    scoreColor: "#dc2626",
    badgeBg: "#fef2f2",
    badgeColor: "#991b1b",
  ...
  },
  {
    ...
    sub: "Product Market Fit phase — You have an MVP and early users, now prove retention.",
  ...
  },
  {
    ...
    sub: "Business Model Validation phase — You have traction, now prove it's sustainable.",
  ...
  },
  {
    ...
    sub: "Growth phase — Your model is validated, time to open the round.",
    diagnosisClass: "green",
    scoreColor: "#16a34a",
    badgeBg: "#f0fdf4",
    badgeColor: "#14532d",
...
export const JOURNEY_STAGES: JourneyStage[] = [
  {
    number: 1,
    title: "Discovery",
    scoreRange: "0 → 20 pts in the journey",
    description: "You are validating the problem and defining your market.",
    gates: [
      "15+ interviews with potential customers",
      "70%+ of respondents rate the problem severity 4–5",
      "3+ demand signals from people you didn't know before",
    ],
    nextStep: "Focus on discovery interviews and problem validation before building.",
  },
  {
    number: 2,
    title: "Product Market Fit",
    scoreRange: "21 → 50 pts in the journey",
    description: "You have an MVP and early users — now you need to prove retention.",
    gates: [
      "Week 2 retention > 30% (without active founder outreach)",
      "Sean Ellis Test > 40% ('very disappointed' if product disappears)",
      "Month 2 cohort ≥ 20% for 2 consecutive cohorts",
    ],
    nextStep: "Measure retention weekly. If below 30%, iterate the product before scaling.",
  },
  {
    number: 3,
    title: "Business Model Validation",
    scoreRange: "51 → 75 pts in the journey",
    description: "You have traction — now you need to prove the business model is sustainable.",
    gates: [
      "Recurring revenue with 3+ active customers",
    ...
    nextStep: "Calculate your real CAC and LTV. These numbers are mandatory for any Seed investor conversation.",
  },
  {
    number: 4,
    title: "Growth",
    scoreRange: "76 → 100 pts in the journey",
    description: "Your model is validated — time to open the round.",
    gates: [
      "MoM growth ≥ 15% for 3 consecutive months",
      "2+ acquisition channels with known CAC",
      "Data Room with 25 documents ready for due diligence",
    ],
    nextStep: "You are ready for Program Raise. Warm introductions convert 10x more than cold outreach.",
  },
]
